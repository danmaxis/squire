...
Implementação: `_pre_homologation_checks` ([`squire.py:567`](../squire.py)).
...
A função `_is_looping` ([`squire.py:293`](../squire.py)) verifica se as
...
([`squire.py:545`](../squire.py)) que continua executando o inner loop
